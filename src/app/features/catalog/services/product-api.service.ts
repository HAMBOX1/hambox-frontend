...
export class ProductApiService {
  ...
  setPendingMerge(productId: string, targetProductId: string): Observable<void> {
    return this.api.post<void>(CATALOG_API.productPendingMerge(productId), { targetProductId });
  }
