...
@Component({
  ...
  selector: 'app-product-inventory-panel',
  ...
  templateUrl: './product-inventory-panel.component.html',

  styleUrl: './product-inventory-panel.component.scss',

  changeDetection: ChangeDetectionStrategy.OnPush,

})

export class ProductInventoryPanelComponent {
  ...
  protected readonly selectedVariantId = this.facade.selectedVariantId;
  ...
  protected readonly batchOptions = computed(() =>
    ...
    this.batchesTable().map((batch) => ({
      ...
      label: this.translate.instant('ADMIN.INVENTORY_PANEL.BATCH_OPTION', {
        name: batch.name,
        count: batch.availableCodes,
      }),
  ...
  protected statusOptions(): { label: string; value: string }[] {
    return [
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.ALL'), value: '' },
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.AVAILABLE'), value: 'Available' },
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.RESERVED'), value: 'Reserved' },
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.SOLD'), value: 'Sold' },
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.EXPIRED'), value: 'Expired' },
      { label: this.translate.instant('ADMIN.INVENTORY_PANEL.STATUS_FILTER.DISABLED'), value: 'Disabled' },
    ];
  }
  ...
  protected selectVariant(variantId: string): void {
    ...
    void this.reloadCodes(variantId, 1);
