...
@Component({
  selector: 'app-store-product-list-item',
  standalone: true,
  imports: [RouterLink, TranslatePipe, HamboxCurrencyPipe],
  templateUrl: './store-product-list-item.component.html',
  styleUrl: './store-product-list-item.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreProductListItemComponent {
