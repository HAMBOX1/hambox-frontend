/** Full PrimeIcons class-name catalog (generated from node_modules/primeicons/primeicons.css). Backs IconPickerComponent — regenerate if primeicons is upgraded with new icon names. */
export const PRIME_ICON_NAMES: readonly string[] = [
  'pi-address-book',
  'pi-align-center',
  'pi-align-justify',
  'pi-align-left',
