...
export const SECURITY_API = {
  ...
  eventStatus: (id: string) => `/api/v1/security/events/${id}/status`,
  loginHistory: '/api/v1/security/login-history',
  ...
  userSessions: (userId: string) => `/api/v1/security/users/${userId}/sessions`,
  revokeAllUserSessions: (userId: string) => `/api/v1/security/users/${userId}/sessions/revoke-all`,
  revokeUserSession: (userId: string, sessionId: string) =>
    `/api/v1/security/users/${userId}/sessions/${sessionId}`,
  ...
  trustDevice: (id: string) => `/api/v1/security/devices/${id}/trust`,
  untrustDevice: (id: string) => `/api/v1/security/devices/${id}/untrust`,
  blockDevice: (id: string) => `/api/v1/security/devices/${id}/block`,
  unblockDevice: (id: string) => `/api/v1/security/devices/${id}/unblock`,
} as const;
